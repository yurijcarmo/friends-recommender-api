...
describe('PersonService', () => {
    ...
    describe('createPerson', () => {
        ...
        it('should throw BadRequestException if the person with the same CPF is '
            + 'already registered', () => {
                const personData = new PersonModel('12345678901', 'Name Test 1');
    ...
    describe('getPerson', () => {
        it('should return a person if CPF exists', () => {
            const personData = new PersonModel('12345678901', 'Name Test 1');
            service.createPerson(personData);
            const person = service.getPerson('12345678901');
            expect(person).toEqual(expect.objectContaining({
                cpf: '12345678901', name: 'Name Test 1'
            }));
        });
    ...
    describe('updatePersonFriends', () => {
        ...
        it('should throw NotFoundException if CPF does not exist for updating '
            + 'friends', () => {
                const cpf = '99999999999';
                expect(() => service.updatePersonFriends(cpf, '22222222222'))
    ...
    describe('setPerson', () => {
        it('should add a person to the list and return the updated list', () => {
            const person1 = new PersonModel('12345678901', 'Person One');
            const person2 = new PersonModel('98765432109', 'Person Two');
    ...
    describe('getPersons', () => {
        it('should return all persons', () => {
            const person1 = new PersonModel('12345678901', 'Alice');
            const person2 = new PersonModel('98765432109', 'Bob');
            service.setPerson(person1);
    ...
    describe('hasRelationship', () => {
        it('should return true if a relationship exists between two CPFs', () => {
            const mockHasRelationship = jest.spyOn(relationshipService, 'hasRelationship');
            mockHasRelationship.mockReturnValue(true);
            const result = service.hasRelationship('12345678901', '98765432109');
